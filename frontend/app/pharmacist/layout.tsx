          ...
          <div className="flex-1 p-4">
            <nav className="space-y-2">
              <Link href="/pharmacist">
                <Button
                  variant={isActive("/pharmacist") ? "default" : "ghost"}
              ...
              <Link href="/pharmacist/medicine">
                <Button
                  variant={
                    pathname.startsWith("/pharmacist/medicine") ? "default" : "ghost"
                  }
                  className="w-full justify-start"
                >
              ...
              <Link href="/pharmacist/prescriptions">
                <Button
                  variant={
                    pathname.startsWith("/pharmacist/prescriptions") ? "default" : "ghost"
                  }
                  className="w-full justify-start"
                >
          ...
          <div className="p-4 border-t">
            <div className="space-y-2">
              <Link href="/pharmacist/settings">
                <Button
                  variant={isActive("/pharmacist/settings") ? "default" : "ghost"}
                  className="w-full justify-start"
                >
          ...
          <div className="px-4 py-3 flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <h1 className="text-lg font-semibold text-gray-900">
                ...
                {pathname.startsWith("/pharmacist/medicine") && "Medicine Management"}
                {pathname === "/pharmacist/prescriptions" && "Prescriptions & Reports"}
                {pathname === "/pharmacist/settings" && "Settings"}
              </h1>
            </div>
